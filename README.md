...
- Video mostrando la compilación y ejecucion de la aplicación cliente-servidor conectados directamente (sin balanceador de carga): [Video](https://youtu.be/1vJujXEkBIw)
